...
var integrations = {
    ...
    messagebird: new IntegrationType(['accessKey', 'originator'], ['displayName']),
    telegram: new IntegrationType(['token'], ['displayName']),
    line: new IntegrationType([['channelId', 'channelAccessToken'], 'channelSecret'], ['displayName', 'qrCodeUrl']),
